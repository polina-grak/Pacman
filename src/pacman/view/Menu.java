...
public class Menu extends JFrame {
    ...
    public Menu(MenuController controller, HighScoreController highScoreController) {
        ...
        newGameBut.addActionListener(e -> controller.mazeSizeChooser(Menu.this));

        highScoresBut.addActionListener(e -> controller.highScoreList(Menu.this, highScoreController));

        exitBut.addActionListener(e -> controller.exit(Menu.this));
